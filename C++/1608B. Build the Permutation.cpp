...
void solve() {
	...
	if (a + b > n - 2 || abs(a - b) > 1) {
		...
		// if (a == 0 && b == 0) {
		// 	rep(i, 1, n - 1) cout << i << ta;
		// 	cout << n << ta << n - 1 << endl;
		// }
		// else if (a == 0 && b == 1) {
		// 	cout << 2 << ta << 1 << endl;
		// 	rep(i, 3, n + 1) cout << i << ta;
		// }
		if (a > b) {
			ll st = n - a;
			repb(i, n, n - a + 1) cout << st << ta << i << ta, st -= 1;
			// cout << endl;

			repb(i, st, 1) cout << i << ta;

			// rep(i, 1, n - st) cout << i << ta;

			// rep(i, n - st, n + 1) cout << i + 1 << ta << i << ta, i += 1;
			cout << endl;
		}
		else if (b > a) {
			ll st = b + 1;
			rep(i, 1, b + 1) cout << st << ta << i << ta, st += 1;
			// cout << endl;
			rep(i, st, n + 1) cout << i << ta;
			cout << endl;
		}
			...
			ll st = a + 2;
			cout << a + 1 << ta;
			rep(i, 1, a + 1) cout << st << ta << i << ta, st += 1;
			rep(i, st, n + 1) cout << i << ta;
			// cout << n << ta << n - 1 << endl;
			cout << endl;
		}
