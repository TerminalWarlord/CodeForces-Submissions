...
// https://codeforces.com/blog/entry/10330?#comment-157225
int msb(unsigned x) {
...
void solve() {
	...
	// 	set_bit += 1;
	// }
	// set_bit = pow(2, set_bit);
	// // cout << set_bit << endl;
	repb(i, set_bit - 1, 0) cout << i << ta;
	rep(i, set_bit, n) cout << i << ta;
	cout << endl;
}
